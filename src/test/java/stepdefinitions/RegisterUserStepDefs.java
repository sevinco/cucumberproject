...
public class RegisterUserStepDefs {
    ...
    public void user_enters_name_and_email() {
        mainPageFunctionalities.nameBox.sendKeys("ozmen");
        mainPageFunctionalities.emailBox.sendKeys("ozmenn@gmail.com");
    }
    ...
    public void userVerifiesEmailAdressIsVisibleIsDisplayed() {
